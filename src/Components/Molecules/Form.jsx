...
export const Form = () => {
  ...
  return (
    <form className='max-w-xs border-black mx-auto mt-8 p-12 rounded-md shadow-lg'>
        ...
        <Input value={email} type="text" placeholder="Email" onChange={setUsername}/>
        </div>
        <div className='mb-5 block'>
          <label htmlFor="" className='text-2xl text-white text-center  font-bold'> Password</label>
        <Input value={password} type="password" placeholder="Username" onChange={setPassword}/>
        </div>
        <div className='flex flex-col justify-center items-center'>
          <button type='submit' className=' bg-purple-900 hover:bg-purple-950 text-white rounded-md py-1 px-6 mt-4' onClick={handleSubmit}> Iniciar sesion</button>
